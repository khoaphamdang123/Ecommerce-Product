...
public class CategoryListService:ICategoryListRepository
{
    ...
    private readonly ILogger<CategoryListService> _logger;

    public CategoryListService(UserManager<ApplicationUser> userManager,RoleManager<IdentityRole> roleManager,Support_Serive.Service service,SmtpService smtpService,ILogger<CategoryListService> logger)
    {
    ...
    public async Task<IEnumerable<ApplicationUser>> filterCategoryList(FilterCategory category)
    {
